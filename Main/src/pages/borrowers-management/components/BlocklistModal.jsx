...
const BlocklistModal = ({
  ...
  if (!isOpen || !borrowerData) return null;
      ...
      <div className="form-modal-panel bg-card rounded-lg border border-border shadow-lg max-w-md w-full">
        ...
        >
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">
              {isUnblocking ? "Unblock Borrower" : "Block Borrower"}
            </h2>
            <p className="text-sm text-muted-foreground">{borrowerData?.name}</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
          ...
          >
            ...
            >
              {isUnblocking
                ? "This borrower will be able to apply for loans again across all branches."
                : "This borrower will be unable to apply for loans across all branches."}
            </p>
          </div>
